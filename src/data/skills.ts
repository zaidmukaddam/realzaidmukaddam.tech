...
export const skills: SkillItem[] = [
  {
    ...
    items: [
      ...
      "devicon-javascript-plain colored JS",
      "devicon-typescript-plain colored TS",
      ...
      "devicon-jquery-plain-wordmark colored jQuery",
    ],
  },
  {
    header: "Backend",
    items: [
      "devicon-nodejs-plain colored Node",
      "devicon-mongodb-plain colored Mongo",
      "devicon-dart-plain colored Dart",
      "devicon-cplusplus-line v C++",
      "devicon-csharp-line colored C#",
      "devicon-c-line colored C",
